...
import PropertyMarker, { K_SCALE_NORMAL } from './PropertyMarker';
import { getScale, getRealFromTo } from '../helpers/GoogleMap/CalcMarkerVisibility';
import markerDescriptions from '../constants/markerDescriptions';
import { customDistanceToMouse } from '../helpers/GoogleMap/CustomDistance';
...
export default controllable(['center', 'zoom', 'markers'])(PropertyMap);
