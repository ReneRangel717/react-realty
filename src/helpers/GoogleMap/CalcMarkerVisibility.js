...
// {l: 10, scale: 0.3}, {l: 5, scale: 0.4} - means
// 10 elements of size 0.3, then 5 sizes 0.4, then those that are visible in a regular-sized tablet
// then again then 5 sizes 0.4, and 10 elements of size 0.3
