...
import IceTableInt from './IceTableInt';

// TODO pass in props in future versions
import {
  columns, cellRenderer, getRowClassNameAt, renderHeader, renderMiniHeader,
  K_ROW_HEIGHT, K_HEADER_HEIGHT, K_MINI_HEADER_HEIGHT
} from './IceTableRenderer.js';
...
export default class IceTable extends Component {
  ...
  _cellRenderer = (cellDataKey, rowData, rowIndex) => (cellRenderer(cellDataKey, rowData, rowIndex));

  _getRowObjectAt = (i) => (this.props.markers && this.props.markers.get(i));

  _getRowClassNameAt = (i, isHovered) => (getRowClassNameAt(i, isHovered || i === this.props.hoveredMapRowIndex, i === this.props.firstInvisibleRowIndex));

  _renderHeader = (resetFn) => renderHeader(resetFn);

  _renderMiniHeader = (resetFn) => renderMiniHeader(resetFn);
